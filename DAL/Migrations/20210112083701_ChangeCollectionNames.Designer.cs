...
namespace DAL.Migrations
{
    ...
    [Migration("20210112083701_ChangeCollectionNames")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.AppUsers.Teacher_Student", b =>
                {
                    b.HasOne("DAL.Models.AppUsers.Student", "Student")
                        .WithMany("TeacherStudentCollection")
            ...
            modelBuilder.Entity("DAL.Models.Classroom_Student", b =>
                {
                    ...
                    b.HasOne("DAL.Models.AppUsers.Student", "User")
                        .WithMany("ClassroomStudentCollection")
            ...
            modelBuilder.Entity("DAL.Models.Classroom_Teacher", b =>
                {
                    ...
                    b.HasOne("DAL.Models.AppUsers.Teacher", "User")
                        .WithMany("ClassroomTeacherCollection")
                        .HasForeignKey("UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DAL.Models.AppUsers.Student", b =>
                {
                    b.Navigation("ClassroomStudentCollection");

                    b.Navigation("StudentExamsCollection");

                    b.Navigation("TeacherStudentCollection");
                });

            modelBuilder.Entity("DAL.Models.AppUsers.Teacher", b =>
                {
                    b.Navigation("ClassroomTeacherCollection");
